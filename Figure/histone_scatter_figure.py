...
defun_path = "/mnt/data0/users/baiy/Sei/sei-framework-main/train/cnn_with_swin_validate_data_12800/cnn_with_swin_histone_feature_auc_12800.csv"
sei_path = "/mnt/data0/users/baiy/Sei/sei-framework-main/train/retrained_sei_validate_data_12800/retrained_sei_histone_feature_auc_12800.csv"
...
ax_main.set_xlabel("DefunCNV AUROC in histone marks feature", fontsize=12)
ax_main.set_ylabel("Sei AUROC in histone marks feature", fontsize=12)
...
plt.savefig('/mnt/data0/users/baiy/CNV/figure/fig_2d_scatter_plot_histone_feature.pdf', dpi=300, format='pdf', bbox_inches='tight')
plt.show()