...
def load_data(fold):
    ...
    with h5py.File(f"/mnt/data0/users/baiy/CNV/data/Brain_CNV_data/five_fold_dataset_0.956_best_model/2638_LR_five_fold_data/train_data/fold_{fold + 1}_train_data.h5", 'r') as f_train:
        train_data = np.array(f_train['data'])
        train_labels = np.array(f_train['labels'])

    with h5py.File(f"/mnt/data0/users/baiy/CNV/data/Brain_CNV_data/five_fold_dataset_0.956_best_model/2638_LR_five_fold_data/val_data/fold_{fold + 1}_val_data.h5", 'r') as f_val:
...
for fold in range(5):
    ...
    # Save best model
    model_filename = f"/mnt/data0/users/baiy/CNV/data/Brain_CNV_data/five_fold_dataset_0.956_best_model/2638_LR_five_fold_data/five_fold_best_param/rf_best_models/fold_{fold + 1}_best_model_rf.pkl"
...
df_results.to_csv(
    '/mnt/data0/users/baiy/CNV/data/Brain_CNV_data/five_fold_dataset_0.956_best_model/2638_LR_five_fold_data/five_fold_best_param/fold_results_rf.csv',
    index=False)
